...
% Last Modified by GUIDE v2.5 21-Oct-2014 13:54:45
...
function representation_Callback(hObject, eventdata, handles)
% hObject    handle to representation (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of representation as text
%        str2double(get(hObject,'String')) returns contents of representation as a double


% --- Executes during object creation, after setting all properties.
function representation_CreateFcn(hObject, eventdata, handles)
% hObject    handle to representation (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% motherfolder = get(handles.mother,'String');
% representation = get(handles.representation,'String');
...
Edge = str2double(get(handles.edge,'String'));
imageanalysis(motherfolder,representation);
...
% Hint: get(hObject,'Value') returns toggle state of cancel
return
...
% --- Executes on button press in motherfolder.
function motherfolder_Callback(hObject, eventdata, handles)
% hObject    handle to motherfolder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global motherfolder;
motherfolder = uigetdir
motherfolder = strcat(motherfolder,'\');
% Hint: get(hObject,'Value') returns toggle state of motherfolder


% --- Executes on button press in representative.
function representative_Callback(hObject, eventdata, handles)
% hObject    handle to representative (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global representation;

[representation path]=uigetfile;
representation
representation = strcat(path,representation);

% Hint: get(hObject,'Value') returns toggle state of representative
